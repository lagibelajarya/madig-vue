    ...
    &-container-1 {
      ...
      &-content {
        ...
        &-head {
          ...
          background-color: white;
          border-bottom: solid 2px rgba($color: #000000, $alpha: 0.3);
          ...
          &-item {
            ...
            svg {
              height: 2rem;
              fill: rgba($color: #000000, $alpha: 0.4);
            }
            p {
              font-size: 1.4rem;
        ...
        &-info {
          ...
          &-action {
            ...
            &-pgs {
              ...
              font-size: 1.6rem;
              font-weight: 500;
              box-shadow: 4px 4px 11px rgba(black, 0.1);
              white-space: nowrap;
              border-radius: 1rem;
              color: white;
            ...
            &-edit {
              cursor: pointer;
              box-shadow: 4px 4px 11px 5px rgba(black, 0.1);
              border-radius: 1rem;
              padding: 1rem 2rem;
              svg {
                height: 2rem;
    ...
    &-box {
      ...
      & .pgs-table {
        ...
        &-head {
          ...
          background-color: rgba(#2962ff, 0.3);
          &-item {
            display: flex;
            justify-content: center;
          }
        ...
        &-body {
          ...
          &-container {
            ...
            display: grid;
            grid-template-columns: repeat(4, calc(100% / 4));
            border-bottom: solid 1px rgba(grey, 0.5);
            &-item {
              display: flex;
              justify-content: center;
              align-items: center;
              ...
              &.img {
                ...
                &-detail {
                  ...
                  background-color: white;
                  border-radius: 1rem;
                  // box-shadow: 0 0 18px rgba(grey, 0.3);
                  display: flex;
                  flex-direction: column;
                  gap: 1rem;
                  div {
